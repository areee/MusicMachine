// Koodin lähde: https://github.com/ernieyu/Swing-range-slider
...
public class RangeSliderDemo extends JPanel {
    ...
    public RangeSliderDemo() {
        ...
        rangeSliderLabel1.setText("Aloituskohta:");
        rangeSliderLabel2.setText("Lopetuskohta:");
    ...
    public void display() {
        ...
        frame.setTitle("Valitse toistokohdat");
